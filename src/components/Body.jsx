...
function Body() {
  ...
  return (
    <div className="w-full"> {/* Added full width */}
      <>
        <meta charSet="UTF-8" />
        ...
        <nav>{<Navbar />}</nav>
        <div>{<Slider />}</div>
        <div id="services" className="py-8 text-white font-sans mr-7 mt-20 flex justify-center items-center">
  <div className="px-2 mx-auto max-w-full w-full"> {/* Removed max-width and reduced padding */}
    <h1 className="text-5xl text-gray-700 font-bold mb-5 text-center">Explore Our Categories</h1>
    <p className="text-gray-700 mb-8 text-center font-serif">Discover your passion</p>
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 justify-items-center"> {/* Adjusted grid */}
    <div className="bg-slate-100 p-4 rounded-lg transition-transform hover:bg-gradient-to-r from-blue-400 via-pink-400 to-red-400 hover:translate-y-[-9px] border-2">
        ...
        <img src={ai} alt="img" className="w-24 h-24 mb-4 rounded-full object-cover mx-auto border-2" /> {/* Smaller image */}
      ...
      <div className="bg-slate-100 p-4 rounded-lg transition-transform hover:bg-gradient-to-r from-blue-400 via-pink-400 to-red-400 hover:translate-y-[-9px] border-2">
        ...
        <button className="text-sm text-black font-serif block mx-auto">Know More
        </button>
        <img src={arrow} className="w-4 h-4 mx-auto mt-2" />
      </div>
  ...
  <img src={arrow} className="w-4 h-4 mx-auto mt-2" />
      ...
      <div className="bg-slate-100 p-4 rounded-lg transition-transform hover:bg-gradient-to-r from-blue-400 via-pink-400 to-red-400 hover:translate-y-[-9px] border-2">
        ...
        <h2 className="text-2xl font-bold mb-2 text-gray-700 text-center">Dream College</h2>
        <p className="mb-4 text-black text-center">Services description to be written.......</p>
        <button className="text-sm text-black font-serif block mx-auto">Know More</button>
        <img src={arrow} className="w-4 h-4 mx-auto mt-2" />
      </div>
